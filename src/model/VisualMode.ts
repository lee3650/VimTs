...
const HandleVisual = (curstate : VimOutput, command : string) : VimOutput => {
    switch (command)
    {
        ...
        case 'j':
            ...
            return new VimOutput(curstate.text, newpos, VISUAL_MODE, curstate.isCntrlKeyDown, curstate.clipboard, curstate.visualStart); 
        case 'Escape': 
            return new VimOutput(curstate.text, curstate.cursorPos, NORMAL_MODE, curstate.isCntrlKeyDown, curstate.clipboard);
    }
