...
export default class Vim {
    ...
    switch (commands) {
      case 'ArrowDown': // move cursor down
        if (this.cursorPos.row < this.text.length - 1) {
          ...
          if (this.cursorPos.col > this.text[this.cursorPos.row + 1].length) {
            ...
            this.cursorPos = new Point(
              ...
              this.text[this.cursorPos.row + 1].length
            )
          } else {
            this.cursorPos = new Point(
              this.cursorPos.row + 1,
      ...
      case 'ArrowRight':
        ...
        if (this.cursorPos.col < this.text[this.cursorPos.row].length) {
    ...
    switch (commands) {
      ...
      case 'd':
        if (this.text[this.cursorPos.row][0] == '\t') {
          this.text[this.cursorPos.row] =
            this.text[this.cursorPos.row].substring(1)
          this.cursorPos = new Point(this.cursorPos.row, this.cursorPos.col - 1)
          return new VimOutput(
            this.text,
            this.cursorPos,
    ...
    switch (commands) {
      ...
      case 'Backspace':
        if (this.cursorPos.col > 0) {
          ...
          newText[this.cursorPos.row] =
            this.text[this.cursorPos.row].slice(0, this.cursorPos.col - 1) +
          ...
          newText[this.cursorPos.row - 1] = newText[
            this.cursorPos.row - 1
          ].concat(newText[this.cursorPos.row])
          let temp = ''
          ...
          this.cursorPos = new Point(
            this.cursorPos.row - 1,
            newText[this.cursorPos.row - 1].length - rowLen
          )
          newText.splice(-1)
          return new VimOutput(
            newText,
      ...
      case 'Delete':
        if (this.cursorPos.col < this.text[this.cursorPos.row].length) {
          ...
          const newText = this.text
          newText[this.cursorPos.row] =
            this.text[this.cursorPos.row].slice(0, this.cursorPos.col) +
            this.text[this.cursorPos.row].slice(this.cursorPos.col + 1)
          return new VimOutput(
            newText,
            this.cursorPos,
            this.mode,
          ...
          this.cursorPos.row <
          this.text[this.cursorPos.row].length - 1
        ) {
          const newText = this.text
          newText[this.cursorPos.row] = newText[this.cursorPos.row].concat(
            newText[this.cursorPos.row + 1]
          )
          let temp = ''
      ...
      case 'Enter': {
        ...
        newText[this.cursorPos.row] = this.text[this.cursorPos.row].slice(
          0,
          this.cursorPos.col
        )
        let replace = ''
  ...
  exec_normal_mode(commands: string): VimOutput {
    switch (commands) {
      ...
      case '$':
        this.cursorPos = new Point(
          this.cursorPos.row,
          this.text[this.cursorPos.row].length
        )
        return new VimOutput(
          this.text,
          this.cursorPos,
  ...
  execute(commands: string): VimOutput {
    ...
    if (this.mode == INSERT_MODE) {
      ...
      let outpt = null
      ;[outpt, this.commandCursorPos, this.commandText] = HandleCommand(
        new VimOutput(
          this.text,
          this.cursorPos,
          COMMAND_MODE,
